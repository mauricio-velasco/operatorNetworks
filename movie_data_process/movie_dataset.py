...
def movie_dataset_processing(df=pd.read_csv(r"../data/movie_dataset.csv"), df_movies=pd.read_csv(r"../data/movielens/movie.csv")):
...
if __name__ == '__main__':
    ...
    distance_matrix = movie_dataset_processing(df, df_movies)
